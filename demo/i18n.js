...
window.PADEL_I18N = {
  es: {
    ...
    'cap.disambig': 'Un «yo» a secas con dos pulls abiertas → el asistente pregunta. Con una sola abierta, o por el nivel del jugador, lo deduce solo.',
  ...
  en: {
    ...
    'cap.disambig': 'A bare “yo” with two open pulls → the assistant asks. With only one open, or from the player’s level, it works it out itself.',
  ...
  sv: {
    ...
    'cap.disambig': 'Ett naket «yo» när två pulls är öppna → assistenten frågar. Med bara en öppen, eller via spelarens nivå, listar den rätt själv.',
